...
Bridgetown.configure do |config|
  ...
  # Articles/slides are populated at build time by ContentFetchBuilder
  # (plugins/builders/content_fetch_builder.rb) from Zenn/Qiita/SpeakerDeck/
  # Fusic/Hatena, not from files under src/.
  collections do
    articles do
      output true
